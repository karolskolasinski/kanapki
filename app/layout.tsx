          ...
          <div className="flex justify-between items-center p-4 md:px-16 max-w-7xl mx-auto">
            <div className="flex items-center gap-2">
              <a href="#" className="flex gap-2 items-center font-bold">
                ...
                <div
                  className={`${calSans.className} flex flex-col uppercase leading-none text-xl tracking-wider`}
                >
                  <div>Jeszcze</div>
                  <div className="flex items-center">ciepłe<span className="text-[1rem]">🔥</span></div>
                </div>
              </a>
            </div>
